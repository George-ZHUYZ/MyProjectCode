(function(e) {
    e.fn.fix = function(t) {
        var n = {"float": "right", minStatue: !1, skin: "gray", durationTime: 0}, t = e.extend(n, t);
        this.each(function() {
            ...
            n.css(t.float, 0), t.minStatue && (e(".show_btn").css("float", t.float), s.css("width", 0), i.css("width", 25)), t.skin && n.addClass("side_" + t.skin), e(window).bind("scroll", function() {
                ...
                s.animate({width: "0"}, "fast"), i.stop(!0, !0).delay(0).animate({width: "33px"}, "fast").css("float", "left")
            }), i.click(function() {
                e(this).animate({width: "0px"}, "fast"), n.width(o), s.stop(!0, !0).delay(0).animate({width: "167px"}, "fast")
            })
        })
    }
})(jQuery)